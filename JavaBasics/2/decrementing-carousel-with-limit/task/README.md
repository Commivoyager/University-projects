...
In this exercise you need to extend [`DecrementingCarousel`](../DecrementingCarousel.java).
You need to implement [`DecrementingCarouselWithLimitedRun`](../DecrementingCarouselWithLimitedRun.java).
